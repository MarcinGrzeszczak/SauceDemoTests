...
WebUI.verifyElementVisible(findTestObject('SauceDemo/div_Sauce Labs Backpack'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('SauceDemo/button_REMOVE'))

WebUI.waitForPageLoad(2)

WebUI.verifyElementNotPresent(findTestObject('SauceDemo/div_Sauce Labs Backpack'), 0)
